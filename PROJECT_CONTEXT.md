...
**Certificates:**
- assets/certificates/ai-automation-certificate-C41295.pdf (AI Automation For Work & Business)
- assets/certificates/ai-builder-n8n-certificate-C42817.pdf (AI Builder: Create Agents & N8N)
...
- Title: "Featured Work"
- Description: "A collection of AI automation projects showcasing workflow automation, AI agents, and intelligent systems."
- Projects Grid: 9 project cards (all completed)

**Projects:**
1. LinkedIn Job Alert Automation System (Status: Completed) - Job hunting automation with keyword filtering and notifications
2. AI Email Automation System (Status: Completed) - Dental clinic email management for appointments
3. Automated Excel Data Processing System (Status: Completed) - Data cleaning with AI-powered validation
4. AI-Powered Image Discovery Agent (Status: Completed) - Smart image search with quality filtering
5. AI Travel Assistant using MCP (Status: Completed) - Trip planning and destination recommendations
6. Smart Student Assistant (Status: Completed) - Academic assistance and study management
7. AI Knowledge Base Support Agent (Status: Completed) - RAG-powered customer support with Supabase Vector Store
8. YouTube Content Automation System (Status: Completed) - End-to-end YouTube content creation workflow
9. Additional AI automation projects (Status: Completed)
...
- Tech stack badges
- Tags
- Links (View Demo - Google Drive links)

**YouTube Content Automation Project:**
- Located in Projects section as project-15
- Demo link: https://drive.google.com/drive/folders/1O8SyXGvcJ9xJMHc94nYXckX1qquv-kHz?usp=drive_link
- Tech stack: n8n, YouTube API, OpenAI, Automation
...
2. WhatsApp - +8801832519176
3. Phone - 01824418009
4. LinkedIn - https://www.linkedin.com/in/arifmohiuddin01
5. GitHub - https://github.com/arifmohiuddin726-ship-it
6. Facebook - https://www.facebook.com/share/17p6AFuXA5/
7. Instagram - https://www.instagram.com/ar.4_if?igsh=MTV1d201MmI4dnpsdA==

### Footer

**Content:**
- Left: Copyright notice " 2026 Arif Mohiuddin. Crafted with passion."
- Right: Social links (GitHub, LinkedIn - both active)
...
- Platform: Ostad The Coach
- Credential ID: C41295
- PDF: assets/certificates/ai-automation-certificate-C41295.pdf
...
- Platform: Ostad The Coach
- Credential ID: C42817
- PDF: assets/certificates/ai-builder-n8n-certificate-C42817.pdf
...
- Projects: 9 completed projects with demo links
- GitHub: Active (https://github.com/arifmohiuddin726-ship-it)
- LinkedIn: Active (https://www.linkedin.com/in/arifmohiuddin01)
